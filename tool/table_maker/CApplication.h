...
//#import "C:\\Program Files (x86)\\Microsoft Office 2007\\OFFICE12\\EXCEL.EXE" no_namespace
// CApplication wrapper class

/*导入Office的类型库*/
#import "C:\\Program Files (x86)\\Microsoft Office 2007\\Office12\\MSO.DLL" \
    rename("RGB", "MSORGB") \
    rename("DocumentProperties", "MSODocumentProperties")
using namespace Office;

/*导入VB的类型库*/
#import "C:\\Program Files (x86)\\Microsoft Office 2007\\Office12\\VBE6EXT.OLB"
using namespace VBIDE;

/*导入Excel的类型库*/
#import "C:\\Program Files (x86)\\Microsoft Office 2007\\Office12\\EXCEL.EXE" \
